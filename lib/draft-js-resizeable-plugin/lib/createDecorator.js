...
exports.default = function (_ref) {
  ...
  return function (WrappedComponent) {
    ...
    return _temp2 = _class = function (_PureComponent) {
      _inherits(BlockResizeableDecorator, _PureComponent);
      ...
      _createClass(BlockResizeableDecorator, [{
        ...
        value: function render() {
          ...
          var _props = this.props,
              ...
              defaultHorizontalWidth = _props.defaultHorizontalWidth,
              defaultVerticalHeight = _props.defaultVerticalHeight,
              vertical = _props.vertical,
              horizontal = _props.horizontal,
              style = _props.style,
              resizeSteps = _props.resizeSteps,
              elementProps = _objectWithoutProperties(_props, ['blockProps', 'defaultHorizontalWidth', 'defaultVerticalHeight', 'vertical', 'horizontal', 'style', 'resizeSteps']);
    ...
    }(_react.PureComponent), _class.displayName = 'BlockDraggable(' + getDisplayName(WrappedComponent) + ')', _class.WrappedComponent = WrappedComponent.WrappedComponent || WrappedComponent, _class.defaultProps = _extends({
      horizontal: 'relative',
      vertical: false,
      resizeSteps: 1,
