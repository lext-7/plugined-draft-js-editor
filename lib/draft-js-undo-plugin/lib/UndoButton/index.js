...
var UndoButton = function (_ListenToSelection) {
  _inherits(UndoButton, _ListenToSelection);
  ...
  function UndoButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UndoButton.__proto__ || Object.getPrototypeOf(UndoButton)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function () {
      _this.setEditorState(_draftJs.EditorState.undo(_this.getEditorState()));
  ...
  _createClass(UndoButton, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'button',
        {
          disabled: !editorState || editorState.getUndoStack().isEmpty(),
          type: 'button',
