...
var Toolbar = function (_React$PureComponent) {
  ...
  function Toolbar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call.apply(_ref, [this].concat(args))), _this), _this.statics = {
      stick: false
    }, _this.state = {
      position: {
        transform: 'scale(0)'
      ...
      var stick = _this.state.stick;

      if ((stick || _this.statics.stick) && _this.state.position.transform !== 'scale(0)') {
        return;
      }
    ...
    }, _this.onStick = function (stick) {
      _this.statics.stick = stick;
      _this.setState({
        stick: stick
      });
